...
<script>
	...
	root.style.setProperty('--primary-color', '{{basicControl()->primaryColor??'#875AFF'}}');
	root.style.setProperty('--btn-bg1', '{{basicControl()->btnColor??'#875AFF'}}');
	root.style.setProperty('--btn-bg2', '{{basicControl()->btnHoverColor??'#875AFF'}}');
</script>
