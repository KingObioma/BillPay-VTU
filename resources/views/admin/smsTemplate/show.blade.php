													...
													<tr>
														...
														<td data-label="@lang('Status')">
															...
															@else
																<span
																	class="badge badge-light"><i
																		class="fa fa-circle text-danger font-12"></i> @lang('DeActive')</span>
															@endif
														</td>
														<td data-label="@lang('Action')">
															<a href="{{ route('sms.template.edit',$template->id) }}"
															   class="btn btn-round btn-sm btn-outline-primary"><i class="fas fa-edit"></i>
															</a>
														</td>
													</tr>
												@endforeach
