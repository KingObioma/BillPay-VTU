			...
			<div class="row g-5 align-items-center">
				...
				<div class="col-sm-6">
					<div class="error-content">
						...
						<div class="error-info">{{trans('The server encountered an internal error misconfiguration and was unable to complate your request.Please contact the server administrator.')}}</div>
						<div class="btn-area">
